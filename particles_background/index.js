class Canvas {
    constructor(canvas) {
        ...
        // style
        this.lineColor = '255,255,255,0.5';
    ...
    drawCanvas() {
        ...
        points.forEach((point, index) => {
            ...
            context.fillRect(point.x - 0.5, point.y - 0, 3, 1, 1);
    ...
    requestFrame(fn) {
        this.timer = requestAnimationFrame(() => { fn.call(this) })
    }

}


window.onload = () => new Canvas(document.querySelector('#canvas'))